...
;
; last saved Time-stamp: <Friday, April 25, 2008  11:31:08  (by dinoch)>
;
...
(setq flymake-gui-warnings-enabled nil)  ;; turn off GUI warnings (eg when no msbuild.flymake.xml file found)
